...
struct MotorConfig {
  ...
  // Parametry silnika
  int   pole_pairs;
  float kv_rating; // KV [RPM/V]
  float phase_resistance; // [Ohm]
  float Kt; // Kt [Nm/A] - stała momentu obrotowego
...
// Konfiguracja płytki i parametrów silnika
extern const MotorConfig GM2804MotorConfig;
extern const MotorConfig ODrive330KVConfig;
